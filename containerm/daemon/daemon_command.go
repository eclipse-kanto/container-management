...
func setupCommandFlags(cmd *cobra.Command) {
	...
	flagSet.DurationVar(&cfg.ContainerClientConfig.CtrImageExpiry, "ccl-image-expiry", cfg.ContainerClientConfig.CtrImageExpiry, "Specify the time period for the cached images content to be kept in the form of e.g. 72h3m0.5s")
