...
func setupCommandFlags(cmd *cobra.Command) {
	...
	flagSet.StringSliceVar(&cfg.ContainerClientConfig.CtrImageVerificationKeys, "ccl-image-verification-keys", cfg.ContainerClientConfig.CtrImageVerificationKeys, "Specify a list of public key filenames to verify image signatures. Each entry can include an optional hash function(e.g. sha512) separated by a colon after the filename. If a hash function is not included, then sha256 will be used by default.")
