...
func (c *containersClient) ListStream(ctx context.Context, in *ListContainersRequest, opts ...grpc.CallOption) (Containers_ListStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Containers_ServiceDesc.Streams[0], "/github.com.eclipse_kanto.container_management.containerm.api.services.containers.Containers/ListStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *containersClient) Attach(ctx context.Context, opts ...grpc.CallOption) (Containers_AttachClient, error) {
	stream, err := c.cc.NewStream(ctx, &Containers_ServiceDesc.Streams[1], "/github.com.eclipse_kanto.container_management.containerm.api.services.containers.Containers/Attach", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *containersClient) Logs(ctx context.Context, in *GetLogsRequest, opts ...grpc.CallOption) (Containers_LogsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Containers_ServiceDesc.Streams[2], "/github.com.eclipse_kanto.container_management.containerm.api.services.containers.Containers/Logs", opts...)
	if err != nil {
		return nil, err
	}
...
func (UnimplementedContainersServer) Start(context.Context, *StartContainerRequest) (*empty.Empty, error) {
...
func (UnimplementedContainersServer) Stop(context.Context, *StopContainerRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Stop not implemented")
}
func (UnimplementedContainersServer) Update(context.Context, *UpdateContainerRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedContainersServer) Restart(context.Context, *RestartContainerRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Restart not implemented")
}
func (UnimplementedContainersServer) Pause(context.Context, *PauseContainerRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Pause not implemented")
}
func (UnimplementedContainersServer) Unpause(context.Context, *UnpauseContainerRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Unpause not implemented")
}
func (UnimplementedContainersServer) Rename(context.Context, *RenameContainerRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Rename not implemented")
}
func (UnimplementedContainersServer) Remove(context.Context, *RemoveContainerRequest) (*empty.Empty, error) {
